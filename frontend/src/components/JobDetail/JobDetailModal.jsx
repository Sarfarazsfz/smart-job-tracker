export default function JobDetailModal({ job, onClose }) {
    ...
    return (
        ...
        >
            ...
            >
                {/* Header */}
                <div className="sticky top-0 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700/50 p-4 md:p-6 z-10">
                    <button
                        className="absolute top-2 right-2 md:top-4 md:right-4 p-2 text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 transition-colors rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800"
                        onClick={onClose}
                    >
                    ...
                    <div className="flex items-start gap-3 md:gap-4 pr-10 md:pr-12">
                        <img
                            src={job.companyLogo}
                            alt={job.company}
                            className="w-12 h-12 md:w-16 md:h-16 rounded-xl object-cover bg-slate-100 dark:bg-slate-700 flex-shrink-0"
                            onError={(e) => {
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="text-sm md:text-base text-slate-700 dark:text-slate-300 font-medium">
                                {job.company}
                            </div>
                        </div>
                    </div>
                ...
                <div className="p-4 md:p-6 space-y-4 md:space-y-6">
                    ...
                    <div className="flex flex-col-reverse sm:flex-row gap-2 md:gap-3 pt-4">
                        ...
                        <button
                            className="sm:flex-none px-4 md:px-6 py-2.5 md:py-3 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 rounded-xl font-medium text-sm transition-colors"
                            onClick={onClose}
                        >
                            Close
                        </button>
